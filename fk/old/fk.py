...
def get_Report_FK(dict_vts, df_KM_aktuell, df_wire, df_bom):
    ...
    for VT in dict_vts:
        ...
        if not VT.lower().startswith('st'):
            ...
            #funcion 7: comprobar índices internos del MV intern vs. la columna int.index. Solo Reportar
            ...
            #función 8: comprobar si los Nummerierungs e IBG concuerdan. Solo Reportar
            ...
            if df_KM_aktuell.empty == False:
                ...
                #función 6: comprobar MV intern con el de la KM-Liste. Solo reportar
                ...
                #función 9: comprobar IBG con el de la KM-Liste. Solo reportar
                ...
                # Función 10: comprobar que aparezcan todos los VT del FK en la KM-Liste
    ...
    dict_Report_final = {'Report_headers' : Report_headers_final,\
                         ...
                         'Duplicated_variants_name' : Report_dup_variant_name,\
                         'Duplicated_variants_content' : Report_dup_variant,\
                         'Missing VT in KM-Liste' : Report_missing_vts}
